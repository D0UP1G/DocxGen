...
/**
 * «Лист» вместо карточки: волосяная рамка и оттенок бумаги, без тени и скругления.
 * Глубина в этом направлении делается светлотой, а не подложкой.
 */
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "font-display text-3xl font-medium leading-tight tracking-tight",
      className
    )}
    {...props}
  />
