...
ВАЖНО: correctedText должен быть ЧИСТЫМ текстом для подстановки в Typst шаблон.
Не добавляй Typst разметку, таблицы, или форматирование — только plain text с абзацами.
...
ООО «Ромашка» рассматривает возможность заключения договора поставки офисной мебели. Просим предоставить коммерческое предложение на 50 столов и 100 стульев с указанием сроков и условий оплаты. Ответ просим направить до 25.03.2025 на office@romashka.example. Надеемся на сотрудничество."
...
{
  "correctedText": "Исправленный текст документа в официально-деловом стиле. Абзацы разделены переносами строк.",
  "requisites": {
