 ...
 * - Extract requisites (recipient, author, date, subject, number, position, signature)
...
3. Извлеки реквизиты: Кому, От кого/Составитель, Должность, Дата, Тема, Номер, Подпись, Обращение, Исполнитель
...
3. НЕ используй символы форматирования: *, #, -, |, >, обратные кавычки
...
ФОРМАТ ОТВЕТА — ТОЛЬКО JSON (без markdown, без комментариев):
{
  ...
  "requisites": {
    ...
    "from": "От кого/составитель или пустая строка",
    "date": "Дата или пустая строка",
    "subject": "Тема/заголовок или пустая строка",
    "number": "Номер или пустая строка",
    "position": "Должность составителя или пустая строка",
    "signature": "Подпись или пустая строка",
    "greeting": "Обращение или пустая строка",
    "executor": "Исполнитель и контакт или пустая строка"
  },
